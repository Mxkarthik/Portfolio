...
const buttonVariants = cva('flex items-center justify-center gap-2 whitespace-nowrap cursor-pointer font-medium rounded-2xl transition-all [&_svg]:size-5',{
    variants : {
        variant : {
            default : 'bg-primary text-on-primary shadow-lg disabled:bg-on-surface/10 disabled:text-on-surface/[0.38] disabled:shadow-none disabled:pointer-events-none hover:opacity-90',
